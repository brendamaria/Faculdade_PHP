...
<body>
    ...
    <main class="main-cons1">
        <section class="pagina-padrao">
            <h3 class="titulo-principal">PESQUISA DE CLIENTE NA SEGURADORA</h3>
            <div class="formulario">

                <form method="post" action="cli_cons2.php">
                    <label for="cod">CÓDIGO: </label>
                    <input class="input-padrao-nb" type="text" id="cod" name="cod" placeholder="Digite o codigo do cliente">
