...
<body>
    ...
    <main class="main-cons1">
        <section class="pagina-padrao">
            <h3 class="titulo-principal">PESQUISA DE OCORRÊNCIA NA SEGURADORA</h3>
            <div class="formulario">

                <form method="post" action="cli_cons2.php">
                    <label for="cod">NÚMERO DA OCORRÊNCIA: </label>
                    <input class="input-padrao-nb" type="text" id="cod" name="cod" placeholder="Digite o número da ocorrência">
                    ...
                    <a href="./ocorrencias.html"> <img src="../img/voltar.png" width="20" height="20"> </a>
                </form>
                <section class="botao">
